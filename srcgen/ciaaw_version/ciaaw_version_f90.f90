...
subroutine write_fortran_capi_module_declaration(fcode, version)
    ...
    write(fcode, "(A)") "module ciaaw__version_capi"
    ...
    write(fcode, "(A)") 'character(kind=c_char), protected, public, bind(C) :: ciaaw_version_capi_version('//trim(nstr)//') = &'
...
subroutine write_fortran_capi_module_end(fcode)
    ...
    integer(int32), intent(in) :: fcode
        !! File unit of the Fortran module.
    write(fcode, "(A)") "end module ciaaw__version_capi"
end subroutine
