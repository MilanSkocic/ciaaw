...
subroutine write_C_header_declaration(fcode, version)
    ...
    write(fcode, "(A)") "*/"
    write(fcode, "(A)") ""
    write(fcode, "(A)") '#ifndef CIAAW_VERSION_H'
    write(fcode, "(A)") '#define CIAAW_VERSION_H'
    ...
    write(fcode, "(A)") 'extern const char ciaaw_version_capi_version['//trim(nstr)//'];'
