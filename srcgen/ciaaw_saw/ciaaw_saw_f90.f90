...
subroutine write_fortran_module_declaration(fcode)
    ...
    write(fcode, "(A)") "type, public :: ciaaw_saw_element_t"
...
subroutine write_fortran_capi_module_declaration(fcode)
    ...
    write(fcode, "(A)") "!! Standard Atomic Weights C API - autogenerated."
    write(fcode, "(A)") "use iso_c_binding"
    write(fcode, "(A)") "use ciaaw__saw"
    write(fcode, "(A)") "implicit none"
    write(fcode, "(A, /)") "private"
    write(fcode, "(A)") "type, public, bind(C) :: ciaaw_saw_capi_element_t"
    write(fcode, "(A)") "!! Object representing an element."
