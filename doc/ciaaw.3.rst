...
atomic weights. The data are taken from http://ciaaw.org. C API allows
...
C API
   ...
   -  double **ciaaw_get_naw(char \*s, int n, int A, bool
      uncertaintuy)**
...
Python wrappers
   ...
   -  **get_saw(s: str, abridged: bool=True, uncertainty:
      bool=False)->float**
