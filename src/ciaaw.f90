...
!     the mean value and the uncertainty are computed using formulas defined in [2].
...
! 
! SEE ALSO
!     gsl(3), codata(3), ciaaw_get_version(3), ciaaw_get_saw(3)
!     ciaaw_get_ice(3), ciaaw_get_nice(3), ciaaw_get_naw(3), ciaaw_get_naw(3)
module ciaaw
