...
def write_module_start(f):
    f.write("! SPDX-License-Identifier: MIT"+newline+newline)
    f.write("!" + "="*71+newline)
    f.write("! MODULE: CIAAW__NAW"+newline)
    f.write("!" + "="*71+newline)
    f.write("module ciaaw__naw" + newline)
    f.write("!! Ciaaw naw - Autogenerated"+newline)
...
def write_constant(f, symbol, A, value, uncertainty):
    ...
    f.write(f"type(naw_type), parameter, public :: {symbol}_naw = &"+newline)
    f.write(f"naw_type({n:d},transpose(reshape([&" + newline)
